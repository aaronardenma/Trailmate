        ...
        <div className="flex flex-col items-center bg-[#DAD7CD] min-h-screen py-10 px-4">
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="flex flex-col items-center gap-5 mt-4">
                    <Badge
                        variant="secondary"
                        className="bg-gray-300 text-[#A3B18A] border-3 border-[#A3B18A]"
                    >
                        {user.badge || "Beginner"}
                    </Badge>
                </div>
            ...
            <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-6 mt-8 w-full max-w-4xl">
                <div>
                    ...
                    <Select
                        onValueChange={(val) => setUser((prev) => ({ ...prev, language: val }))}
                        value={user.language || ""}
                    >
                        ...
                        <SelectContent>
                            <SelectGroup>
                                ...
                                {["english", "french", "chinese", "spanish", "korean"].map(
                                    (lang) => (
            ...
            <button
                ...
                className="mt-6 max-w-4xl w-full bg-gray-600 text-white font-semibold py-3 rounded hover:bg-gray-700 transition"
            >
                Log Out
            </button>
        </div>
